...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./DRG.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
--------------------------------------------------------------------------------------------------------------
function S_a_i_d_i(msg,data) -- بداية العمل
if msg then
...
os.execute('rm -rf DRG.lua')
os.execute('wget https://raw.githubusercontent.com/JABWA/Saidi/main/DRG.lua')
...
send(msg.chat_id_, msg.id_,'☽ اصدار سورس صعيدي{ S:2【 ✅ 】}')
end
if text == '𓆩•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•𓆪' then
local Text = [[ 
[◤━─━━─⊶❲𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐈𝐃𝐈❳⊷━─━━─◥](http://t.me/S_a_i_d_i)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '◢مـبــرمـج السـورس◤', url="t.me/J_A_B_W_A"}}, 
{{text = '◢مـالك السـورس◤', url="t.me/ttimo_2lby"}}, 
{{text = '◢بــوت توصـل السـورس◤', url="t.me/Bot_JABWA_Bot"}}, 
{{text = '◢قناة السـورس◤', url="t.me/S_a_i_d_i"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](t.me/S_a_i_d_i)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
if text == 'مصطفي مبرمج السورس' and Devban(msg) then
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
...
if AddChannel(msg.sender_user_id_) == false then
local S_a_i_d_i = bot_data :get(ban_id ..'text:ch:user')
if S_a_i_d_i then
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "صعيدي")
...
local msg_id = msg.id_/2097152/0.5  
local textt = "S_a_i_d_i"..(bot_data:get(ban_id..'Name:Bot') or 'صعيدي')
...
if text == 'المالك تيمو' or text == 'تيمو' or text == 'مالك سورس' or text == 'عاوز بوت' or text == 'عاوزه بوت' or text == 'عوز انصب' or text == 'عوزه انصب' then
local Text = [[
[𝗐ᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴢᴀʀᴀᴛ ᴛɪᴍᴏ](http://t.me/ttimo_2lby)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
[•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•](http://t.me/S_a_i_d_i)
...
send(msg.chat_id_, msg.id_, t..'◤━─━❲sᴏᴜʀᴄᴇ sᴀɪᴅɪ´❳━─━◥\nاضغط علي الاسم ليتم نسخه\n[`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](t.me/S_a_i_d_i)')
end
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'صعيدي').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'صعيدي')
local DRAGON_Msg = {
'نعم يروحي🌝💙',
'نعم يا قلب  '..Namebot..'',
'عوز اي مني '..Namebot..'',
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'صعيدي').." غادر" or text == 'غادر' and Sudo(msg) then     
...
send(msg.chat_id_,msg.id_, '[لا عيب بتكسف 😹💔](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اي الثقافه دي 😒😹](t.me/S_a_i_d_i)')
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´',url="t.me/S_a_i_d_i"},{text = 'ᴘᴏѕᴛᴀᴛ ᴍᴏѕᴛᴀғᴀ',url="t.me/POSTAT_MOSTAFA"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❥♢𝗧𝗘𝗠✹⃝🇧🇱𝗘𝗟𝗠𝗟𝗢𝗞♔⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ',url="t.me/B_A_R_J_A_B_W_A"}},
{{text = '`ʙᴀᴄᴋ´', callback_data="/TTT"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
╣ السورس بيه كل مميزات اللي ممكن تحتاجه ➷
╣ في بوتك الخاص بيك بوت حمايه الجروبات ➷
╣ السورس خاص لي بوتات الحمايه من والسب ➷
╣ السروس علي اامن مستواء علي الاطلاق ➷
╣ يوجد اغاني وي افلام وي بحث يوتيوب ➷
╣ يوجد ردود داخل السورس ردود جميل جدا ➷
╝ لي مراقبة الجودة سورس انضم الي قنات السورس ➷
◣━─━━─⊶❲𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐈𝐃𝐈❳⊷━─━━─◢
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`تــواصــل الـسـورس´',url="t.me/ELGAMDEN_BOT"}}, 
{{text = '`قناة السـورس´', url="t.me/S_a_i_d_i"}},
{{text = '`ʙᴀᴄᴋ´', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• مبرمج جابوا •',url="t.me/J_A_B_W_A"},{text = '• مالك سورس تيمو •', url="t.me/ttimo_2lby"}},
...
الاعمال الملائمة : أطباء، صيادلة، مدرصعيدي، أخصائيو تغذية، شيف، سماسرة
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'صعيدي')
