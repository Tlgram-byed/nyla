...
sudo_users = {SUDO,1965534755,1987201540}   
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي مصطفى')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
if text == 'احمد المصري مبرمج السورس' and Devban(msg) then
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
المبرمج مصطفى لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴊᴀʙᴡᴀ',url="t.me/DEV_AH8"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
𓆩 رجل اشترى جهاز كهربائي بخصم 20% من إجمالي قيمة الجهاز، وهي نسبة تساوي 150 ريال؟.ما هي قيمة الجهاز 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{{text = 'D𝒆𝒗', url="http://t.me/"..sudos.UserName}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/43&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local texxxtt = ''..result.first_name_..''
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = texxxtt, url="t.me/"..dofile("./Info.lua").botUserName},
},
{
{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"},
},
...
if Text == '/Timo' then
local Teext =[[
𝗐ᴇʟᴄᴏᴍᴇ ᴛᴏ ᴄʜᴀɴɴᴇʟѕ ᴛɪᴍᴏ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´',url="t.me/g_00_l_d"},{text = 'ᴘᴏѕᴛᴀᴛ ᴀʜᴍᴇᴅ ᴀʟᴍѕʀʏ',url="t.me/AKJA0"}},
...
if Text == '/Timo2' then
local Teext =[[
𝗐ᴇʟᴄᴏᴍᴇ ᴛᴏ ᴘʀᴀᴛᴛ ᴛɪᴍᴏ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❥♢𝗧𝗘𝗠✹⃝🇧🇱𝗘𝗟𝗠𝗟𝗢𝗞♔⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ',url="t.me/B_A_R_DEV_AH8"}},
{{text = '`B𝐚𝐜𝐤´', callback_data="/TTT"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بــوت حـمـايه',url="t.me/Timo8Bot"}},
{{text = '`B𝐚𝐜𝐤´', callback_data="/TTT"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
