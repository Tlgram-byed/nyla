...
{{text = '◢بــوت توصـل السـورس◤', url="t.me/Bot_JABWA_Bot"}}, 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`S𝑜𝑢𝑟𝑐𝑒 G𝑜𝑙𝑑´',url="t.me/g_00_l_d"},{text = 'ᴘᴏѕᴛᴀᴛ ᴀʜᴍᴇᴅ ᴀʟᴍѕʀʏ',url="t.me/POSTAT_MOSTAFA"}},
...
local Teext =[[
• مـرحـبــا بــك في سـورس صـعيدي •
]]
keyboard = {} 
keyboard.inline_keyboard = {
